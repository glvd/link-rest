...
func PrintHeaderAndUtilityMethods(w io.Writer, pkg string) error {
	...
	return doTemplate(w, data, `// Code generated by github.com/glvd/link-rest/library/whyrusleeping/cbor-gen. DO NOT EDIT.
...
`)
	...
	case "github.com/glvd/link-rest/library/ipfs/go-cid.Cid":
		return doTemplate(w, f, `
{{ if .Pointer }}
	if {{ .Name }} == nil {
