...
import (
	...
	caopts "github.com/glvd/link-rest/library/ipfs/interface-go-ipfs-core/options"
	ma "github.com/glvd/link-rest/library/multiformats/go-multiaddr"
	manet "github.com/glvd/link-rest/library/multiformats/go-multiaddr-net"
...
// HttpApi implements github.com/glvd/link-rest/library/ipfs/interface-go-ipfs-core/CoreAPI using
// IPFS HTTP API.
//
// For interface docs see
// https://godoc.org/github.com/glvd/link-rest/library/ipfs/interface-go-ipfs-core#CoreAPI
type HttpApi struct {
	url         string
