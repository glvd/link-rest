...
import (
	...
	ipfspath "github.com/glvd/link-rest/library/ipfs/go-path"
...
func (api *HttpApi) ResolvePath(ctx context.Context, p path.Path) (path.Resolved, error) {
	...
	//TODO: this is hacky, fixing https://github.com/glvd/link-rest/library/ipfs/go-ipfs/issues/5703 would help
